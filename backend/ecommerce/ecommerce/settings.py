...
if not SECRET_KEY:
    if DEBUG:
        SECRET_KEY = 'django-insecure-paras-traders-dev-key-change-in-production'
    else:
...
CORS_ALLOWED_ORIGINS = _env_list('DJANGO_CORS_ALLOWED_ORIGINS', 'http://127.0.0.1:5173,http://localhost:5173')
CSRF_TRUSTED_ORIGINS = _env_list('DJANGO_CSRF_TRUSTED_ORIGINS', 'http://127.0.0.1:5173,http://localhost:5173')
