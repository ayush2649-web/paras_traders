...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        products_data = [
            ...
            {'name': 'Tommy Hilfiger Polo Shirt', 'description': 'Slim fit polo shirt in premium cotton piqué. Classic Tommy flag logo embroidered on chest.', 'price': 3499, 'original_price': 4999, 'category': 'Fashion', 'stock': 80, 'brand': 'Tommy Hilfiger', 'image_filename': 'tommy-hilfiger-polo.png'},
            {'name': 'Adidas Ultraboost 23', 'description': 'Running shoes with BOOST midsole, Continental rubber outsole, and Primeknit+ upper for adaptable comfort.', 'price': 16999, 'original_price': 19999, 'category': 'Fashion', 'stock': 40, 'brand': 'Adidas', 'image_filename': 'adidas-ultraboost-23.png'},
            {'name': 'Fossil Gen 6 Smartwatch', 'description': 'Wear OS smartwatch with Snapdragon 4100+, heart rate monitor, SpO2, GPS, and NFC payments.', 'price': 18495, 'original_price': 24995, 'category': 'Fashion', 'stock': 25, 'brand': 'Fossil', 'image_filename': 'fossil-gen-6-smartwatch.png'},
            ...
            {'name': 'Nespresso Vertuo Next', 'description': 'Coffee machine with centrifusion technology, 5 cup sizes, Wi-Fi connected, and one-touch brew system.', 'price': 13990, 'original_price': 16990, 'category': 'Home & Kitchen', 'stock': 20, 'brand': 'Nespresso', 'image_filename': 'nespresso-vertuo-next.png'},
            {'name': 'IKEA KALLAX Shelf Unit', 'description': '4x4 shelving unit in white. Perfect for organizing books, decor, and storage boxes. 147x147cm.', 'price': 7990, 'original_price': 9990, 'category': 'Home & Kitchen', 'stock': 10, 'brand': 'IKEA', 'image_filename': 'ikea-kallax-shelf-unit.png'},
            ...
            # Books
            {'name': 'Atomic Habits', 'description': 'An Easy & Proven Way to Build Good Habits & Break Bad Ones by James Clear. Bestselling self-help book.', 'price': 399, 'original_price': 699, 'category': 'Books', 'stock': 200, 'brand': 'Penguin', 'image_filename': 'atomic-habits.png'},
            {'name': 'The Psychology of Money', 'description': 'Timeless Lessons on Wealth, Greed, and Happiness by Morgan Housel. A masterpiece on financial behavior.', 'price': 349, 'original_price': 599, 'category': 'Books', 'stock': 150, 'brand': 'Jaico', 'image_filename': 'the-psychology-of-money.png'},
            {'name': 'Clean Code', 'description': 'A Handbook of Agile Software Craftsmanship by Robert C. Martin. Essential reading for every developer.', 'price': 2499, 'original_price': 3499, 'category': 'Books', 'stock': 50, 'brand': 'Pearson', 'image_filename': 'clean-code.png'},
            {'name': 'Sapiens: A Brief History', 'description': 'Sapiens: A Brief History of Humankind by Yuval Noah Harari. A thought-provoking journey through human evolution.', 'price': 449, 'original_price': 699, 'category': 'Books', 'stock': 120, 'brand': 'Vintage', 'image_filename': 'sapiens-a-brief-history.png'},

            # Sports & Fitness
            {'name': 'Fitbit Charge 6', 'description': 'Advanced fitness tracker with GPS, heart rate, stress management, sleep tracking, and 7-day battery life.', 'price': 14999, 'original_price': 17999, 'category': 'Sports & Fitness', 'stock': 35, 'brand': 'Fitbit', 'image_filename': 'fitbit-charge-6.png'},
            {'name': 'Yoga Mat Premium 6mm', 'description': 'Extra thick non-slip yoga mat with alignment lines. Made from eco-friendly TPE material. 183x61cm.', 'price': 1299, 'original_price': 2499, 'category': 'Sports & Fitness', 'stock': 100, 'brand': 'Boldfit', 'image_filename': 'yoga-mat-premium-6mm.png'},
            {'name': 'Whey Protein Isolate 2kg', 'description': 'Premium whey protein isolate with 26g protein per serving. Zero sugar, gluten-free. Double chocolate flavor.', 'price': 3999, 'original_price': 5999, 'category': 'Sports & Fitness', 'stock': 60, 'brand': 'MuscleBlaze', 'image_filename': 'whey-protein-isolate-2kg.png'},
            {'name': 'Adjustable Dumbbells 24kg', 'description': 'Space-saving adjustable dumbbell set with 15 weight settings from 2.5kg to 24kg. Quick-change mechanism.', 'price': 19999, 'original_price': 29999, 'category': 'Sports & Fitness', 'stock': 20, 'brand': 'Bowflex', 'image_filename': 'adjustable-dumbbell-24kg.png'},

            # Beauty & Health
            {'name': 'The Ordinary AHA 30% + BHA 2%', 'description': '10-minute exfoliating facial with alpha and beta hydroxy acids. Targets uneven skin tone and texture.', 'price': 990, 'original_price': 1290, 'category': 'Beauty & Health', 'stock': 80, 'brand': 'The Ordinary', 'image_filename': 'the-ordinary-aha-30-bha-2.png'},
            ...
            {'name': 'Cetaphil Moisturizing Cream 550g', 'description': 'Dermatologist recommended moisturizer for dry to very dry skin. Fragrance-free, non-comedogenic.', 'price': 899, 'original_price': 1299, 'category': 'Beauty & Health', 'stock': 100, 'brand': 'Cetaphil', 'image_filename': 'cetaphil-moisturizing-cream.png'},
