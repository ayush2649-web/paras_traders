...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        products_data = [
            # Electronics
            {'name': 'iPhone 15 Pro Max', 'description': 'Apple iPhone 15 Pro Max with A17 Pro chip, 256GB storage, titanium design. Features a 48MP camera system, always-on display, and USB-C connectivity.', 'price': 134900, 'original_price': 159900, 'category': 'Electronics', 'stock': 25, 'brand': 'Apple', 'is_featured': True},
            {'name': 'Samsung Galaxy S24 Ultra', 'description': 'Samsung Galaxy S24 Ultra with Snapdragon 8 Gen 3, 200MP camera, S Pen, AI features. 6.8" Dynamic AMOLED display with titanium frame.', 'price': 129999, 'original_price': 144999, 'category': 'Electronics', 'stock': 30, 'brand': 'Samsung', 'is_featured': True},
            {'name': 'MacBook Air M3', 'description': 'Apple MacBook Air with M3 chip, 15.3" Liquid Retina display, 8GB RAM, 256GB SSD. Up to 18 hours battery life.', 'price': 134900, 'original_price': 139900, 'category': 'Electronics', 'stock': 15, 'brand': 'Apple', 'is_featured': True},
            {'name': 'Sony WH-1000XM5', 'description': 'Premium wireless noise-cancelling headphones with 30-hour battery, multipoint connection, and crystal-clear calls.', 'price': 26990, 'original_price': 34990, 'category': 'Electronics', 'stock': 50, 'brand': 'Sony', 'is_featured': True},
            {'name': 'iPad Air M2', 'description': 'Apple iPad Air with M2 chip, 11" Liquid Retina display, 128GB. Perfect for creative work with Apple Pencil Pro support.', 'price': 59900, 'original_price': 64900, 'category': 'Electronics', 'stock': 20, 'brand': 'Apple'},
            {'name': 'Dell XPS 15', 'description': 'Dell XPS 15 with Intel Core i7-13700H, 16GB RAM, 512GB SSD, NVIDIA RTX 4050. 15.6" 3.5K OLED display.', 'price': 159990, 'original_price': 179990, 'category': 'Electronics', 'stock': 10, 'brand': 'Dell'},
            {'name': 'AirPods Pro 2', 'description': 'Apple AirPods Pro (2nd gen) with USB-C, Active Noise Cancellation, Adaptive Audio, and Personalized Spatial Audio.', 'price': 24900, 'original_price': 26900, 'category': 'Electronics', 'stock': 60, 'brand': 'Apple'},
            {'name': 'Canon EOS R50', 'description': 'Mirrorless camera with 24.2MP APS-C sensor, 4K video, Dual Pixel CMOS AF II. Ideal for content creators.', 'price': 65990, 'original_price': 72990, 'category': 'Electronics', 'stock': 12, 'brand': 'Canon'},

            # Fashion
            {'name': 'Levi\'s 501 Original Jeans', 'description': 'Classic straight-fit jeans with button fly. Made from premium selvedge denim for lasting quality and timeless style.', 'price': 3999, 'original_price': 5999, 'category': 'Fashion', 'stock': 100, 'brand': 'Levi\'s', 'is_featured': True},
            {'name': 'Nike Air Max 270', 'description': 'Lifestyle sneakers with Max Air unit for comfort. Mesh upper for breathability, rubber outsole for traction.', 'price': 12995, 'original_price': 14995, 'category': 'Fashion', 'stock': 45, 'brand': 'Nike', 'is_featured': True},
            {'name': 'Ray-Ban Aviator Classic', 'description': 'Iconic aviator sunglasses with polarized G-15 lenses and gold metal frame. UV400 protection.', 'price': 8490, 'original_price': 10990, 'category': 'Fashion', 'stock': 35, 'brand': 'Ray-Ban'},
            ...
            # Home & Kitchen
            {'name': 'Dyson V15 Detect', 'description': 'Cordless vacuum cleaner with laser dust detection, HEPA filtration, and up to 60 minutes runtime.', 'price': 62900, 'original_price': 72900, 'category': 'Home & Kitchen', 'stock': 15, 'brand': 'Dyson', 'is_featured': True},
            {'name': 'Philips Air Fryer XXL', 'description': 'Digital air fryer with 7.3L capacity, Rapid Air technology, and smart sensing for perfect results every time.', 'price': 14999, 'original_price': 19999, 'category': 'Home & Kitchen', 'stock': 30, 'brand': 'Philips'},
            ...
            {'name': 'Prestige Omega Deluxe Cookware Set', 'description': '5-piece non-stick cookware set with granite finish. Includes fry pan, kadhai, tawa, saucepan with lids.', 'price': 2999, 'original_price': 4999, 'category': 'Home & Kitchen', 'stock': 40, 'brand': 'Prestige'},
            ...
            {'name': 'Dyson Airwrap Multi-Styler', 'description': 'Complete hair styling tool with Coanda airflow technology. Curls, waves, smooths, and dries. 6 attachments included.', 'price': 44900, 'original_price': 49900, 'category': 'Beauty & Health', 'stock': 15, 'brand': 'Dyson', 'is_featured': True},
            ...
            {'name': 'Oral-B iO Series 9', 'description': 'Electric toothbrush with AI-powered brushing recognition, 3D tracking, 7 cleaning modes, and magnetic charging.', 'price': 18999, 'original_price': 24999, 'category': 'Beauty & Health', 'stock': 25, 'brand': 'Oral-B'},
        ]
        ...
        self.stdout.write(self.style.SUCCESS(f'Created {len(products_data)} products across {len(categories)} categories'))
